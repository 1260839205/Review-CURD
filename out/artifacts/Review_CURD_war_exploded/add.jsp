    ...
    <script>
        function su() {
            ...
            ||(qq == '' || qq == undefined || qq == null || qq == ' ')||(email == '' || email == undefined || email == null || email == ' ')){
                ...
                for (var a = 0;a < ${requestScope.allUser.size()};a++){
                    if (qq == ${requestScope.allUser.get(a)}){
                        alert("此qq已被人注册，请重新填写");
                        var event = event || window.event;
                        event.preventDefault(); // 兼容标准浏览器
                        window.event.returnValue = false;
                    }
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/addUserServlet" id="add" method="post">
        ...
        <div class="form-group">
            ...
            <select name="hometown" class="form-control" id="hometown">
